...
@section('content')
    ...
    <div class="container">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('products.destroy', $product) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Are your sure ?')"><i class="bi bi-trash"></i></button>
                                </form>
                            </div>
                        </div>
                    </a>
        ...
        <div class="row">
            <div class="col-md-6">
                    <a href="/" class="text-center btn btn-success"><i class="bi bi-arrow-left"></i></a>
            </div>

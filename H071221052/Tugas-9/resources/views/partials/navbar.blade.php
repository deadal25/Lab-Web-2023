<nav class="navbar navbar-expand-lg bg-success py-4 px-5">
  <div class="container">
    <a class="navbar-brand fw-bold fs-4 text-white" href="/">Isekai Thrift</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{ route('category.products', 'Baju') }}">Baju</a></li>
            <li><a class="dropdown-item" href="{{ route('category.products', 'Celana') }}">Celana</a></li>
            <li><a class="dropdown-item" href="{{ route('category.products', 'Sweater') }}">Sweater</a></li>
            <li><a class="dropdown-item" href="{{ route('category.products', 'Sepatu') }}">Sepatu</a></li>
